...
<head>
  ...
  <title>Parsa Momeni</title>
  <link rel="icon" type="images/x-png" href="images/icon4.png">
...
<body id="top">
  <header>
    <div class="profile-page sidebar-collapse">
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
        <div class="container">
          <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Parsa Momeni</a>
        ...
        <div class="wrapper">
          <div class="page-header page-header-small" filter-color="green">
            <div class="page-header-image" data-parallax="true"
              style="background-image: url('https://wallpaper-mania.com/wp-content/uploads/2018/09/High_resolution_wallpaper_background_ID_77701447012.jpg')">
            </div>
            <div class="container">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <p>Hello! I am Parsa Momeni. Web Developer and C# Programmer.</p>
                  <p>An organized individual with more than 4 years of experience in software development.
                    Have well understanding and knowledge in computer software programs. Also bring
                    the last college degree, strong attention to detail, and accuracy. Committed and
                    collaborated in engineering projects to meet and client requirements. Passionate to
                    contribute my skills and expertise developing software as part of a team. <a
              ...
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-8">prmomeni@outlook.com</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
                    <div class="col-sm-8">+4915151591585</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
                    <div class="col-sm-8">40/34 Dwell Melbourne 3001</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
                    <div class="col-sm-8">English, German, Persian</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">C#, JavaScript</span>
                    <div class="progress">
                      <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10"
                        data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                        aria-valuemax="100" style="width: 70%;"></div><span class="progress-value">65%</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">PHP, SQL</span>
                    <div class="progress">
                      <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10"
                        data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                        aria-valuemax="100" style="width: 60%;"></div><span class="progress-value">75%</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">Bootstrap</span>
                    <div class="progress">
                      <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10"
                        data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                        aria-valuemax="100" style="width: 40%;"></div><span class="progress-value">60%</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                      <a href="#web-development">
                        <figure class="cc-effect"><img src="images/project-3.jpg" alt="Image" />
                          <figcaption>
                            <div class="h4">Library Website Application</div>
                            <p>Web Development</p>
                          </figcaption>
                        </figure>
                      </a>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                      <a href="#web-development">
                        <figure class="cc-effect"><img src="images/project-4.jpg" alt="Image" />
                          <figcaption>
                            <div class="h4">Windows Application</div>
        ...
        <div class="container cc-experience">
            ...
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  ...
                  <p>C# Software developer at iSon international team company
                    • Design, development and testing of new features
                    • Learning new algorithms technologies for optimizing projects
          ...
          <div class="card">
            <div class="row">
              <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body cc-experience-header">
                  <p>May 2016 - February 2019</p>
                  <div class="h5">HOST</div>
                </div>
              </div>
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Host Managemer</div>
                  <p>C#.Net and SQL Software developer at Dibagaran company
                    • Rendering services, testing-developing software
                    • mongering of Host Affairs
                    • maintaining of WHMCS servers
                    • Development and create new solutions in C#.Net
                    • maintaining and editing customer data and information in SQL
                    • learning new technologies and AI solutions
                    • collaboration with data maintaining manager.
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Windows Application Developer</div>
                  <p>C++ Code profiling, version control in research and design
                    • Be working in small development university team group
                    • Learning new algorithms technologies for optimizing projects
                    • Code design and maintaining
                    • Learning complete software life-cycle implementation.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="row">
              <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body cc-experience-header">
                  <p>September 2011 - February 2014</p>
                  <div class="h5">Software tester</div>
                </div>
              </div>
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Software Developer and Software Tester</div>
                  <p>C# Software developer at Iran University of Science and Technology
                    • Writing and testing code
                    • Debugging and troubleshooting with careful planning and testing
        ...
        <div class="container cc-education">
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Information Technology and Internet Systems</div>
                  <p class="category">Leibniz Universität Hannover</p>
                  <p>Research and Thesis on Dewelopment and Test: Dewelopment of WEB applications using
                    HTML, CSS and PHP. Integrating and Composing different veriaty of practical applications(for
                    instanse:
                    Identifying cancer tomors by Artificial Intelligence)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  ...
                  <p class="category">Iran University of Science and Technology</p>
                  <p>Research and Thesis on Requirement Engineering: Simulation of requirement engineering with
                    implementation of use cases in Rational Rose and translate application
                    storyboards and use cases into functional applications in C#.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  ...
                  <p class="category">Mofateh Highschool</p>
                  <p></p>
                </div>
              </div>
            </div>
        ...
        <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row">
                <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image1.jpg" alt="Image" />
                  <div class="h5 pt-2">Amir</div>
                  <p class="category">WEBD Manager</p>
                </div>
                <div class="col-lg-10 col-md-9">
                  <p>He established the Cyber-Physical Systems (CPS) laboratory at IUST. He was a member of the
                    Dependable Systems
                    Laboratory from 2010 to 2017. As a Visiting Researcher, he was with the Embedded Systems
                    Laboratory, University
                    of California, Irvine, CA, USA from 2016 to 2017.</p>
                </div>
              </div>
            </div>
            <div class="carousel-item">
              <div class="row">
                <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image2.jpg" alt="Image" />
                  <div class="h5 pt-2">Wolfgang</div>
                  <p class="category">Pjt Manager</p>
                </div>
                <div class="col-lg-10 col-md-9">
                  <p>You see things and say "Why?",
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image3.jpg" alt="Image" />
                  <div class="h5 pt-2">Morteza</div>
                  <p class="category">CEO</p>
                </div>
                <div class="col-lg-10 col-md-9">
                  <p> He received a B.A. degree in Electrical Engineering from Iran University of Science and
                    Technology (IUST)
                    in 1983 and a Ph.D. degree in Electrical Engineering from Okayama University, Japan, in 1989.
                    Dr. Analoui
                    is an Associate Professor in the College of Computer Engineering at IUST, where he has been
                    since 1995.
                    He is the director of Computer Network Research Lab at IUST.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <footer class="footer">
    ...
    <div class="h4 title text-center">Parsa Momeni</div>
    <div class="text-center text-muted">
      <p>&copy; Creative CV. All rights reserved.<br>Design - <a class="credit" href="https://parsamomeni.com"
          target="_blank">Parsa Momeni</a></p>
    </div>
  </footer>
